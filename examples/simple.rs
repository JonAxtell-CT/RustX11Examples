...
fn main() {
    ...
    let mut window_attributes: x11_dl::xlib::XSetWindowAttributes = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
    ...
    let mut cur_window_attributes: x11_dl::xlib::XWindowAttributes = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
